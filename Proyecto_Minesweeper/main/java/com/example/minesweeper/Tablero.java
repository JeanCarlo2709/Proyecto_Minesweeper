...
public class Tablero {
    ...
    /**
     * Coloca a los botones los numeros de minas mas proximas
     */
    public static void SetMinesProximity() { // Coloca los numeros de las minas proximas
        ...
        /**
         * El metodo colorFijo establece el color de el tablero variar el color del tablero para simular otros escenarios
        ...
        public static void colorFijo ( int i, int j, int colorbtn){ // Establece el color del tablero
            ...
            //else if (colorbtn == 1) { // El numero es 1
                //Tablerobtn[i][j].setStyle("-fx-background-color: #ADFF2F;-fx-border-color: #272323;"); // Establece el color del boton
            //}
            //else if(colorbtn == 2) { // El numero es 2
            //    Tablerobtn[i][j].setStyle("-fx-background-color: #90EE90;-fx-border-color: #272323;"); // Establece el color del boton
            //}
            //else if(colorbtn == 3) { // El numero es 3
            //    Tablerobtn[i][j].setStyle("-fx-background-color: #F0E68C;-fx-border-color: #272323;"); // Establece el color del boton
            //}
        }
